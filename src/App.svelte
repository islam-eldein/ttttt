...
<!-- Developed by and telegram button -->
{#if !is_getting_data && show_developed_by}
  <Github/>
  <h4 in:blur={{duration:1000,delay:500}} class="fixed whitespace-nowrap bottom-8 left-1/2 text-white text-lg md:text-2xl -translate-x-1/2 z-50">طُور بواسطة <a href="https://t.me/islam_eldein" target="_blank" class="hover:underline">اسلام الدين</a> ♥</h4>
{/if}
